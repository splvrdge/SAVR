...
const SystemScreen = () => {
  ...
  const fetchTerms = async () => {
    ...
    switch (decodedTitle) {
      case "Sample Terms":
        url = "https://rtm-aiven-backend.onrender.com/api/volume/sample-terms";
        break;
      case "Skeletal System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/skeletal-terms";
        break;
      case "Cardiovascular System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/cardiovascular-terms";
        break;
      case "Integumentary System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/integumentary-terms";
        break;
      case "Nervous System":
        url = "https://rtm-aiven-backend.onrender.com/api/volume/nervous-terms";
        break;
      case "Reproductive System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/reproductive-terms";
        break;
      case "Respiratory System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/respiratory-terms";
        break;
      case "Urinary System":
        url = "https://rtm-aiven-backend.onrender.com/api/volume/urinary-terms";
        break;
      case "Digestive System":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/digestive-terms";
        break;
      case "Immune System":
        url = "https://rtm-aiven-backend.onrender.com/api/volume/immune-terms";
        break;
      case "Joint and Directional Terms":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/joint-and-directional-terms";
        break;
      case "Latin Muscle Names in English":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/latin-muscle-names-in-english";
        break;
      case "Muscular System Physiology":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/muscular-system-physiology";
        break;
      case "Plane and Directional Terms":
        url =
          "https://rtm-aiven-backend.onrender.com/api/volume/plane-and-directional-terms";
        break;
      default:
